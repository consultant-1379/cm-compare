...
public class MetricProducer {
    ...
    public Timer produceTimer(final InjectionPoint ip) {
        ...
        return this.metricRegistryWrapper.timer(getMetricNameFromInjectionPoint(ip));
    }
    ...
    public Meter produceMeter(final InjectionPoint ip) {
        ...
        return this.metricRegistryWrapper.meter(getMetricNameFromInjectionPoint(ip));
    }
    ...
    public Counter produceCounter(final InjectionPoint ip) {
        ...
        return this.metricRegistryWrapper.counter(getMetricNameFromInjectionPoint(ip));
    }
    ...
    public Histogram produceHistogram(final InjectionPoint ip) {
        ...
        return this.metricRegistryWrapper.histogram(getMetricNameFromInjectionPoint(ip));
    }
}
