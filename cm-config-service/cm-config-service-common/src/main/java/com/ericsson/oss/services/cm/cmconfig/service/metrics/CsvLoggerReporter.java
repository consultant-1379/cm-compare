...
public class CsvLoggerReporter extends ScheduledReporter {
    ...
    private static final SimpleDateFormat localDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    private void log(final String metricName, final Object... values) {
        ...
        this.logger.info(this.marker, record.substring(0, record.length() - 1));
    }
    ...
    public static final class Builder {
        ...
        public CsvLoggerReporter build() {
            return new CsvLoggerReporter(this.registry, this.logger, this.marker, this.rateUnit, this.durationUnit, this.filter);
        }
    }
}
