...
/**
 * 
 * Delete Config command handler.
 * 
 */
@DeleteConfig
public class DeleteConfigCommandHandler extends CommandHandler {
    ...
    public CmResponse getCmResponse(final ParserResult parserResult) {
        ...
        return this.cmCompareService.deleteConfig(parserResult.getConfigurationName());
