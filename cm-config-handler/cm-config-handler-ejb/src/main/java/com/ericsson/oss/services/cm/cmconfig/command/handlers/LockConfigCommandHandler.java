...
/**
 * 
 * Lock Config command handler.
 * 
 */
@LockConfig
public class LockConfigCommandHandler extends CommandHandler {
    ...
    public CmResponse getCmResponse(final ParserResult parserResult) {
        ...
        return this.cmCompareService.lockConfig(parserResult.getConfigurationName(), parserResult.getLockReasonMessage());
