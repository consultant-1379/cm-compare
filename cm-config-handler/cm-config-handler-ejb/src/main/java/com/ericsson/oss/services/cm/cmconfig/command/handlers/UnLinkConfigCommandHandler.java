...
/**
 * 
 * Unlink Config command handler.
 * 
 */
@UnlinkConfig
public class UnLinkConfigCommandHandler extends CommandHandler {
    ...
    public CmResponse getCmResponse(final ParserResult parserResult) {
        ...
        return this.cmCompareService.unlockConfig(parserResult.getConfigurationName());
